...
public class CameraFadeFrom : MonoBehaviour
{   
	...
	private Color m_CurrentScreenOverlayColor = new Color(0,0,0,1);	// default starting color: black and fully transparrent
